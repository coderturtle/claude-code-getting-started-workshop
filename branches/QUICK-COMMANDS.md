# QUICK-COMMANDS.md — One-shot tagging loop (maintainers)
_Last updated: 2026-01-02_

> Maintainers only. Run this inside your real git repo, after unpacking the workshop pack (also available in create-branches.sh).
